...
//void OGLRenderer::SetShaderLight(vector<Light> l) {
//	Vector3 lightPosArray[4];
//	Vector4 lightColourArray[4];
//	float lightRadiusArray[4];
//	for (int i = 0; i < 4; i++) {
//		lightPosArray[i] = l[i].GetPosition();
//		lightColourArray[i] = l[i].GetColour();
//		lightRadiusArray[i] = l[i].GetRadius();
//	}
//	glUniform3fv(glGetUniformLocation(currentShader->GetProgram(), "lightPos"), 4, (float*)lightPosArray);
//
//	glUniform4fv(glGetUniformLocation(currentShader->GetProgram(), "lightColour"), 4, (float*)lightColourArray);
//
//	glUniform1fv(glGetUniformLocation(currentShader->GetProgram(), "lightRadius"), 4, (float*)lightRadiusArray);
//}
